...
class RecoveryPageLocators:
    ...
    recovery_input_password_field = [By.XPATH, ".//label[text()='Пароль']/../" "input[@type='password' and @name='Введите новый пароль']"]
    recovery_input_visible_password_field = [By.XPATH, ".//label[text()='Пароль']/../" "input[@type='text' and @name='Введите новый пароль']"]
