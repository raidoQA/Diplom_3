...
class OrderFeedPageLocators:
    ...
    order_number_in_modal = [By.XPATH, ".//section[contains(@class, 'modal_opened')]//" "div[contains(@class, 'Modal_modal__contentBox')]/" "p[contains(@class, 'text_type_digits-default')]"]
    top_order_number_in_feed = [By.XPATH, ".//ul[contains(@class, 'OrderFeed_list')]/li[1]//" "div[contains(@class, 'OrderHistory_textBox')]/" "p[contains(@class, 'text_type_digits-default')]"]
    number_in_new_order_modal = [By.XPATH, ".//section[contains(@class, 'modal_opened')]//" "div[contains(@class, 'Modal_modal__contentBox')]/" "h2[contains(@class, 'text_type_digits-large')]"]
    ...
    ingredient_filling_counter = [By.XPATH, ".//a[@href='/ingredient/61c0c5a71d1f82001bdaaa6e']//p[contains(@class, 'counter')]"]
    ...
    order_history_list = [By.XPATH, ".//div[contains(@class, 'Account_contentBox')]//ul[contains(@class, 'OrderHistory_list')]"]