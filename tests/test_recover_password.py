...
class TestRecoveryPassword:
    ...
    @allure.description("Открыть страницу авторизации, кликнуть кнопку Восстановить пароль проверить что текущая страница изменилась на страницу восстановления доступа")
    ...
    @allure.description("Открыть страницу восстановления пароля, ввести значение в поле ввода email и кликнуть Восстановить. Проверить, что текущая страница изменилась на страницу ввода пароля")
    ...
    @allure.description("Перейти на страницу востановления пароля, ввести email, кликнуть Восстановить, на следующей странице ввести пароль, нажать кнопку показать/скрыть пароль. Проверить, что локатора type изменил значение на text")
